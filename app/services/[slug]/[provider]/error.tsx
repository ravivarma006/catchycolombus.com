  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-2">Could not load provider</h2>
        <p className="text-gray-500 mb-6 text-sm">Something went wrong loading this business listing. Please try again.</p>
