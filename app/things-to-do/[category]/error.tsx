  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-2">Could not load this page</h2>
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <a href="/things-to-do" className="bg-gray-100 text-gray-700 px-5 py-2 rounded-lg font-semibold text-sm hover:bg-gray-200 transition">
            Things to Do
          </a>
        </div>
      </div>
